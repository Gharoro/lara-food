              ...
              <form id="contact-me" class="w-full mx-auto max-w-9xl bg-white shadow p-8 text-gray-700 ">
                  ...
                  <div class="flex flex-wrap mb-6">
                      <div class="relative w-full appearance-none label-floating">
                          ...
                          id="name" type="text" placeholder="Your Restaurant Name"required>
                      </div>
                  </div>
                  <!-- address field -->
                  <div class="flex flex-wrap mb-6">
                      ...
                      <div class="relative w-full appearance-none label-floating">
                          <input class="tracking-wide py-2 px-4 mb-3 leading-relaxed appearance-none block w-full border border-gray-200 rounded focus:outline-none focus:bg-white focus:border-gray-500"
                          id="name" type="text" name="address" placeholder="Address e.g 42, Main Street, Main Island"required>
                      </div>
                  </div>
                  ...
                  <div class="flex flex-wrap mb-6">
                      ...
                      <div class="relative w-full appearance-none label-floating">
                          <input class="tracking-wide py-2 px-4 mb-3 leading-relaxed appearance-none block w-full border border-gray-200 rounded focus:outline-none focus:bg-white focus:border-gray-500"
                          id="name" type="text" name="state" placeholder="State"required>
                      </div>
                  </div>
                  ...
                  <div class="flex flex-wrap mb-6">
                      ...
                      <div class="relative w-full appearance-none label-floating">
                          <input class="tracking-wide py-2 px-4 mb-3 leading-relaxed appearance-none block w-full border border-gray-200 rounded focus:outline-none focus:bg-white focus:border-gray-500"
                          id="name" type="text" name="city" placeholder="City"required>
                      </div>
                  </div>
